...
We use [mdBook](https://rust-lang.github.io/mdBook/index.html) for the documentation portion of the webpage. So, you will need to install Rust and then use Cargo to install `mdbook`. There are instructions on the mdBook webpage. The mdBook project is handled in `./documentation-book`.